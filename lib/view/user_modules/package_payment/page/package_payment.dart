...
import 'package:wed_crew/view/user_modules/package_payment/page/success_page.dart';
import 'package:wed_crew/view/user_modules/package_payment/service/card_package_service.dart';
import 'package:wed_crew/view/user_modules/package_payment/service/upi_package_service.dart';
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: const Color.fromARGB(255, 11, 101, 54),
    ...
    try {
      ...
      if (responseMessage.message == 'Google Pay payment successful!') {
       ...
       Navigator.push(
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Payment failed: ${responseMessage.message}')),
        );
      }
    } catch (e) {
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              ...
              backgroundColor: const Color.fromARGB(255, 39, 150, 87),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(12),
              ),
              elevation: 5,
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              padding: const EdgeInsets.symmetric(vertical: 14),
              backgroundColor: const Color.fromARGB(255, 15, 128, 88),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(12),
              ),
              elevation: 5,
