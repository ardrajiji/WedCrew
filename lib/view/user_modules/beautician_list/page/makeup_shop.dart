...
class BeauticianVendorPage extends StatefulWidget {
  final MakeupModel studio;
  
  const BeauticianVendorPage({super.key, required this.studio});

  @override
  _BeauticianVendorPageState createState() => _BeauticianVendorPageState();
}

class _BeauticianVendorPageState extends State<BeauticianVendorPage> {
  int _currentIndex = 0;
