...
class VenueVendorPage extends StatefulWidget {
  final VenueModel studio;
  
  const VenueVendorPage({super.key, required this.studio});

  @override
  _VenueVendorPageState createState() => _VenueVendorPageState();
}

class _VenueVendorPageState extends State<VenueVendorPage> {
  int _currentIndex = 0;
