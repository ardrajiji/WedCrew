...
List<BookingListModel> bookingListModelFromJson(String str) => List<BookingListModel>.from(json.decode(str).map((x) => BookingListModel.fromJson(x)));

String bookingListModelToJson(List<BookingListModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class BookingListModel {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "time": time ?? "00:00:00",
        "date": date != null ? "\${date!.year.toString().padLeft(4, '0')}-\${date!.month.toString().padLeft(2, '0')}-\${date!.day.toString().padLeft(2, '0')}" : "0000-00-00",
