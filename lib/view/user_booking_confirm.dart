...
class UserBookingLastPayment extends StatefulWidget {
  const UserBookingLastPayment({super.key});

  @override
  UserBookingLastPaymentState createState() => UserBookingLastPaymentState();
}

class UserBookingLastPaymentState extends State<UserBookingLastPayment> {
  String? selectedBank;
